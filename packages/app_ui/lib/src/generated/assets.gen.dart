...
class $AssetsAnimationsGen {
  ...
  String get checkedAnimation => 'packages/app_ui/assets/animations/checked-animation.json';
...
class $AssetsIconsGen {
  ...
  SvgGenImage get chatCircle => const SvgGenImage('assets/icons/chat_circle.svg');
  ...
  SvgGenImage get instagramReel => const SvgGenImage('assets/icons/instagram-reel.svg');
  ...
  SvgGenImage get verifiedUser => const SvgGenImage('assets/icons/verified_user.svg');

  /// List of all assets
  List<SvgGenImage> get values =>
      [addButton, chatCircle, check, github, google, instagramReel, search, setting, trash, user, verifiedUser];
}
...
class $AssetsImagesGen {
  ...
  AssetGenImage get chatBackgroundLightMask => const AssetGenImage('assets/images/chat-background_light_mask.png');

  /// File path: assets/images/chat_background_dark_mask.jpeg
  AssetGenImage get chatBackgroundDarkMask => const AssetGenImage('assets/images/chat_background_dark_mask.jpeg');
  ...
  SvgGenImage get instagramTextLogo => const SvgGenImage('assets/images/instagram_text_logo.svg');
  ...
  AssetGenImage get profilePhoto => const AssetGenImage('assets/images/profile_photo.png');
